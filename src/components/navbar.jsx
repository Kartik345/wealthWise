  ...
  return (
    <div className="w-full flex items-center justify-between py-6">
      <div className="flex items-center gap-2 cursor-pointer">
        ...
        <span className="text-xl font-bold text-black dark:text-white">WealthWise</span>
      </div>
      ...
      <div className="flex items-center gap-10 2xl:gap-20"> 
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:block">
            <p className="text-lg font-medium text-black dark:text-gray-400">Kartik Pethani</p>
            <span className="text-sm text-gray-700 dark:text-gray-500">xyz@gmail.com</span>
          </div>
