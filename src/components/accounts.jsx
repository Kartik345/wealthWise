...
const Accounts = () => {
  return (
    <div className="mt-20 md:mt-0 py-4 md:py-20 md:w-1/3">
      ...
      <div className='w-full'>
        {
          data.map((item, index) => (
            <div key={index} className='flex items-center gap-6 justify-between'>
              ...
              <div>
                <p className='text-xl text-black dark:text-gray-400 font-medium'>${item.account}</p>
                <span className="text-gray-600 text-sm dark:text-violet-700">Account Balance</span>
              </div>
            </div>
          ))
        }
